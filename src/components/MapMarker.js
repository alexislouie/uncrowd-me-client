...
export default class MapMarker extends Component {
    ...
    handleClick() {
        const { name, address, lat, lng, $dimensionKey } = this.props;
        this.props.showInfoBox(name, address, lat, lng, $dimensionKey);
    }
    ...
    render() {
        ...
        const { $hover, $dimensionKey, userLocation, updateHoveredMarker, hoveredCardId, currentHover, text, index, clickedMarker } = this.props;

        let style;

        // don't want to allow hover style change for userLocation
